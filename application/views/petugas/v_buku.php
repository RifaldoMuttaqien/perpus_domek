<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <a href="<?php echo base_url() . 'petugas/buku_tambah' ?>" class="btn btn-sm btn-success"><i
                    class="fa fa-plus">Buku Baru</i></a>
            <br />
            <br />
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url() . 'petugas/buku_hapus/' . $b->id; ?>"
                                    ...
                                    onclick="return confirm('Yakin mau dihapus data buku ini?')"><i
